...
var _AppStyle = __webpack_require__(29);

var styles = _interopRequireWildcard(_AppStyle);
...
var App = function (_Component) {
    ...
    function App(props) {
        ...
        _this.clockIntervall = null;

        _this.handleClockClick = _this.handleClockClick.bind(_this);
        _this.handleAddBreakLength = _this.handleAddBreakLength.bind(_this);
        _this.handleAddSessionkLength = _this.handleAddSessionkLength.bind(_this);
        _this.handleSubtractBreakLength = _this.handleSubtractBreakLength.bind(_this);
        _this.handleSubtractSessionkLength = _this.handleSubtractSessionkLength.bind(_this);
    ...
    _createClass(App, [{
        ...
        key: 'handleSubtractBreakLength',
        value: function handleSubtractBreakLength() {
        ...
        key: 'handleSubtractSessionkLength',
        value: function handleSubtractSessionkLength() {
        ...
        key: 'handleAddBreakLength',
        value: function handleAddBreakLength() {
            if (this.state.break) {
                this.setState({
                    breakLength: this.state.breakLength + 1,
                    timeLeft: (this.state.breakLength + 1) * 60,
        ...
        key: 'handleAddSessionkLength',
        value: function handleAddSessionkLength() {
            if (!this.state.break) {
                this.setState({
                    sessionLength: this.state.sessionLength + 1,
                    timeLeft: (this.state.sessionLength + 1) * 60,
        ...
        key: 'getTimeAsString',
        value: function getTimeAsString() {
            var seconds = ("0" + this.state.timeLeft % 60).slice(-2);
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement(
                        ...
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                'div',
                                { className: styles.AppHeadControls },
                                _react2.default.createElement(
                                    'button',
                                    { onClick: this.handleSubtractBreakLength },
                                    '-'
                                ),
                                _react2.default.createElement(
                                    'span',
                                ...
                                _react2.default.createElement(
                                    'button',
                                    { onClick: this.handleAddBreakLength },
                                    '+'
                                )
                            )
                        ),
                        _react2.default.createElement(
                            ...
                            _react2.default.createElement(
                                ...
                                _react2.default.createElement(
                                    'button',
                                    { onClick: this.handleSubtractSessionkLength },
                                    '-'
                                ),
                                _react2.default.createElement(
                                    'span',
                                ...
                                _react2.default.createElement(
                                    'button',
                                    { onClick: this.handleAddSessionkLength },
                                    '+'
                                )
                            )
                        )
                    ...
                    _react2.default.createElement(
                        'div',
                        { style: style, className: styles.AppClock, onClick: this.handleClockClick },
                        _react2.default.createElement(
                            'div',
                            null,
                            _react2.default.createElement(
                                'span',
                                null,
                                this.state.break ? "Break!" : "Work my little Ninja!"
                            ),
...
if(false) {
	...
	if(!content.locals) {
		module.hot.accept("!!../node_modules/css-loader/index.js?module&localIdentName=[hash:base64:5]!../node_modules/sass-loader/lib/loader.js?indentedSyntax&outputStyle=expdanted!./App.style.sass", function() {
			var newContent = require("!!../node_modules/css-loader/index.js?module&localIdentName=[hash:base64:5]!../node_modules/sass-loader/lib/loader.js?indentedSyntax&outputStyle=expdanted!./App.style.sass");
